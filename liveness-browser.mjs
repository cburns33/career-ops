/**
 * liveness-browser.mjs ΓÇö Playwright-driven liveness check for a single URL.
 *
...
// `reason`. Stable codes ΓÇö not regex on reason strings ΓÇö drive downstream
...
export async function checkUrlLiveness(page, url) {
  ...
  try {
    ...
    // Transient failures (timeout, DNS, TLS, 5xx) shouldn't be treated as expired ΓÇö
